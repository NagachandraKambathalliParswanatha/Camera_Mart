$(document).ready(function ()
{
    ...
    elementHandle[24] = $('[name="fnameB"]');
    elementHandle[25] = $('[name="lnameB"]');
    ...
    function validate_Data() {
        ...
        if (isEmpty(elementHandle[23].val()))
        {
            ...
            errorStatusHandle.html("Please Enter Secure code");
            errorStatusHandle.show();
        ...
        if ((!$.isNumeric(elementHandle[23].val())) || ((elementHandle[23].val()).length < 3)) {
            elementHandle[23].addClass("error");
            errorStatusHandle.html("Invalid SecureCode, Enter a valid 3 digit Secure code");
            errorStatusHandle.show();
            elementHandle[23].focus();
            return false;
        }
